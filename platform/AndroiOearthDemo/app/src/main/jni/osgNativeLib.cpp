...
extern "C" {
    ...
    JNIEXPORT void JNICALL Java_com_example_androioearthdemo_osgNativeLib_mouseMoveEvent(JNIEnv * env, jobject obj, jfloat x, jfloat y);
    JNIEXPORT void JNICALL Java_com_example_androioearthdemo_osgNativeLib_keyboardDown(JNIEnv * env, jobject obj, jint key);
...
extern "C" JNIEXPORT void JNICALL Java_com_example_androioearthdemo_osgNativeLib_mouseButtonPressEvent(JNIEnv * env, jobject obj, jfloat x, jfloat y, jint button){
    mainApp.mouseButtonPressEvent(x,y,button);
}

extern "C" JNIEXPORT void JNICALL Java_com_example_androioearthdemo_osgNativeLib_mouseButtonReleaseEvent(JNIEnv * env, jobject obj, jfloat x, jfloat y, jint button){
    mainApp.mouseButtonReleaseEvent(x,y,button);
}

extern "C" JNIEXPORT void JNICALL Java_com_example_androioearthdemo_osgNativeLib_mouseMoveEvent(JNIEnv * env, jobject obj, jfloat x, jfloat y){
    mainApp.mouseMoveEvent(x,y);
}
extern "C" JNIEXPORT void JNICALL Java_com_example_androioearthdemo_osgNativeLib_keyboardDown(JNIEnv * env, jobject obj, jint key){
    mainApp.keyboardDown(key);
}
extern "C" JNIEXPORT void JNICALL Java_com_example_androioearthdemo_osgNativeLib_keyboardUp(JNIEnv * env, jobject obj, jint key){
